...
$(this).on('click',"#update",function(e)
			...
			// alert(last_name);
				...
				//alert(img);
			//	var image = $('#vendor_name').attr('src');
				// alert(mobile_no);
				// alert(land_line);
				//alert(filename);
				$.ajax({
					url : "updateuser.php",
					method:"post",
					data:{id:id,first_name:first_name,last_name:last_name,mobile_no:mobile_no,land_line:land_line},
					success:function(response)
					{
