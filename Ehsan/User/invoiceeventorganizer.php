...
<div id="invoice">
    ...
    $_SESSION['newfunctiontype'] = $functiontype;
    $type = $_POST['type'];
    $_SESSION['newtype'] = $type;
     $noofpersion = $_POST['noofperson'];
    $_SESSION['newnoofperson'] = $noofpersion;
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h2 class="page-header">
                                    ...
                                    <small name="total" class="pull-right">Date: <?php echo Date("d/m/y"); ?></small>
                                </h2>
                            </div><!-- /.col -->
                        </div>
                        <!-- info row -->
